...
const ZH_CN: &[(&str, &str)] = &[
    ...
    ("menu_new_codex_session", "新建 Codex 会话"),
    ("menu_new_omp_session", "新建 oh my pi 会话"),
    ("menu_settings", "设置…"),
...
const EN_US: &[(&str, &str)] = &[
    ...
    ("menu_new_codex_session", "New Codex Session"),
    ("menu_new_omp_session", "New oh my pi Session"),
